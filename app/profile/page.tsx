...
<span className='mt-2 bg-pallette5 p-1 rounded-full'>{profile?.email}</span>
...
<Card className='flex flex-col items-center'>
  ...
  <ShoppingCart/>
    <Link className='bg-green-400 rounded p-2 hover:bg-green-600' href='/cart'>Cart</Link>
  </CardContent>
</Card>
<Card className='flex flex-col items-center'>
  <CardHeader>
  ...
  <CardContent className='flex flex-col items-center gap-2'>
  <Heart/>
    <Link className='bg-green-400 rounded p-2 hover:bg-green-600' href='/wishlist'>Wishlist</Link>
  </CardContent>
</Card>
<Card className='flex flex-col items-center'>
  <CardHeader>
  ...
  <CardContent className='flex flex-col items-center gap-2'>
  <Package/>
    <Link className='bg-green-400 rounded p-2 hover:bg-green-600' href='/orders'>Orders</Link>
  </CardContent>
</Card>
